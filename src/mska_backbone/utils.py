...
try:
    ...
    # Cached-feature translation experiments only use XentLoss from this
    # module. TensorFlow is needed solely by the legacy CTC decoder below,
    # so keep it optional in lightweight cloud environments.
    tf = None
